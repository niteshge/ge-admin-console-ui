...
@Component({
  selector: 'app-condition-one-edit',
  templateUrl: './condition-one-edit.component.html',
  styleUrls: ['./condition-one-edit.component.css']
})
export class ConditionOneEditComponent implements OnInit {
  rowData;
  ...
  constructor(
    public dialogRef: MatDialogRef<ConditionOneEditComponent>,
  ...
  ngOnInit() {
    ...
    // ) {
    //   let allSegment = [];
    //   allSegment = this.rowData['ALL SEGMENT ONE'];
    //   if (
    //     this.rowData['ALL SEGMENT ONE'] === null ||
    //     this.rowData['ALL SEGMENT ONE'] === '' ||
    //     allSegment.length > 0
    //   ) {
    ...
    // ) {
    //   let allSegment = [];
    //   allSegment = this.rowData['ALL SEGMENT TWO'];
    //   if (
    //     this.rowData['ALL SEGMENT TWO'] === null ||
    //     this.rowData['ALL SEGMENT TWO'] === '' ||
    //     allSegment.length > 0
    //   ) {
    ...
    // ) {
    //   let allSegment = [];
    //   allSegment = this.rowData['ALL SEGMENT THREE'];
    //   if (
    //     this.rowData['ALL SEGMENT THREE'] === null ||
    //     this.rowData['ALL SEGMENT THREE'] === '' ||
    //     allSegment.length > 0
    //   ) {
    ...
    // }
    // if (
    //   this.rowData['SEGMENT FOUR'] === null ||
    //   this.rowData['SEGMENT FOUR'] === ''
    // ) {
    //   let allSegment = [];
    //   allSegment = this.rowData['ALL SEGMENT FOUR'];
    //   if (
    //     this.rowData['ALL SEGMENT FOUR'] === null ||
    //     this.rowData['ALL SEGMENT FOUR'] === '' ||
    //     allSegment.length > 0
    //   ) {
