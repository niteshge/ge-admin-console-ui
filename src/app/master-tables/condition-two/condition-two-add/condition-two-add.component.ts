...
@Component({
  selector: 'app-condition-two-add',
  templateUrl: './condition-two-add.component.html',
  styleUrls: ['./condition-two-add.component.css']
})
export class ConditionTwoAddComponent implements OnInit {
  rowData;
  ...
  constructor(
    public dialogRef: MatDialogRef<ConditionTwoAddComponent>,
