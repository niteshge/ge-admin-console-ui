...
@Component({
  selector: 'app-condition-four-add',
  templateUrl: './condition-four-add.component.html',
  styleUrls: ['./condition-four-add.component.css']
})
export class ConditionFourAddComponent implements OnInit {
  rowData;
  ...
  constructor(
    public dialogRef: MatDialogRef<ConditionFourAddComponent>,
