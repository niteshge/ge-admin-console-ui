...
@Component({
  selector: 'app-infocus-template-one-four-two-two',
  templateUrl: './infocus-template-one-four-two-two.component.html',
  styleUrls: ['./infocus-template-one-four-two-two.component.css']
})
export class InfocusTemplateOneFourTwoTwoComponent implements OnInit {
  ...
  postInfocusReport() {
    this.infocusModel.templateType = 5;
