...
@Component({
  selector: 'app-infocus-template-one-four-two-two-solution-two-companies-two',
  templateUrl: './infocus-template-one-four-two-two-solution-two-companies-two.component.html',
  styleUrls: ['./infocus-template-one-four-two-two-solution-two-companies-two.component.css']
})
export class InfocusTemplateOneFourTwoTwoSolutionTwoCompaniesTwoComponent implements OnInit {
  ...
  businessPriority2PlaceholderValue(value) {
    if (value == "Business Priority 2A") {
      ...
      this.infocusModel.businessPriority2d = this.businessPriority2Value;
      this.getSolutions1(this.infocusModel.businessPriority2d);
      this.getSolutions2(this.infocusModel.businessPriority2d);
    }
  }
  ...
  businessPriority2Solutions1Selected(solution) {
    if (this.businessPriorityPlaceholder == "Business Priority 2A") {
    ...
    } else if (this.businessPriorityPlaceholder == "Business Priority 2B") {
      let splitedSolutionNameNdCode = this.splitSolutionNameNdCode(solution)
    ...
    } else if (this.businessPriorityPlaceholder == "Business Priority 2C") {
      let splitedSolutionNameNdCode = this.splitSolutionNameNdCode(solution)
    ...
    }else if (this.businessPriorityPlaceholder == "Business Priority 2D") {
      let splitedSolutionNameNdCode = this.splitSolutionNameNdCode(solution)
      this.infocusModel.bp2dSolution1 = splitedSolutionNameNdCode[0];
      this.infocusModel.bp2dSolution1Code = splitedSolutionNameNdCode[1];
      let randomValue = Math.random();
      this.infocusCoreService.getInfocusCompanyDetails(this.infocusModel.bp2dSolution1Code, randomValue)
        .subscribe(
          (response: Response) => {
            this.companyDetails1 = response;
            this.concatenateCompanyNameScoreAndId(this.companyDetails1, this.listOfSolution1AllCompanies);
  ...
  businessPriority2Solutions2Selected(solution) {
    if (this.businessPriorityPlaceholder == "Business Priority 2A") {
      ...
      let splitedSolutionNameNdCode = this.splitSolutionNameNdCode(solution)
      this.infocusModel.bp2dSolution2 = splitedSolutionNameNdCode[0];
      this.infocusModel.bp2dSolution2Code = splitedSolutionNameNdCode[1];
      let randomValue = Math.random();
      this.infocusCoreService.getInfocusCompanyDetails(this.infocusModel.bp2cSolution2Code, randomValue)
        .subscribe(
          (response: Response) => {
  ...
  solution1companyDetail(companyPlaceholder) {
    if (companyPlaceholder == "Solution 1 Company 1") {
      ...
      if (this.businessPriorityPlaceholder == "Business Priority 2A") {
        ...
        this.infocusModel.bp2dSolution1CompanyLogo1 = temp[0].logourl
        this.infocusModel.bp2dSolution1CompanyLocation1 = temp[0].country;
        this.infocusModel.bp2dSolution1CompanyName1 = temp[0].company_name;
        this.infocusModel.bp2dSolution1CompanyDomainName1 = temp[0].domain_name;
        this.infocusModel.bp2dSolution1CompanyMaturityStatus1 = temp[0].maturity;
      }
      ...
      if (this.businessPriorityPlaceholder == "Business Priority 2A") {
        ...
        this.infocusModel.bp2dSolution1CompanyLogo2 = temp[0].logourl
        this.infocusModel.bp2dSolution1CompanyLocation2 = temp[0].country;
        this.infocusModel.bp2dSolution1CompanyName2 = temp[0].company_name;
        this.infocusModel.bp2dSolution1CompanyDomainName2 = temp[0].domain_name;
        this.infocusModel.bp2dSolution1CompanyMaturityStatus2 = temp[0].maturity;
      }
    }
  ...
  solution2companyDetail(companyPlaceholder) {
    if (companyPlaceholder == "Solution 2 Company 1") {
      ...
      if (this.businessPriorityPlaceholder == "Business Priority 2A") {
        ...
        this.infocusModel.bp2dSolution2CompanyLogo1 = temp[0].logourl
        this.infocusModel.bp2dSolution2CompanyLocation1 = temp[0].country;
        this.infocusModel.bp2dSolution2CompanyName1 = temp[0].company_name;
        this.infocusModel.bp2dSolution2CompanyDomainName1 = temp[0].domain_name;
        this.infocusModel.bp2dSolution2CompanyMaturityStatus1 = temp[0].maturity;
      }
      ...
      if (this.businessPriorityPlaceholder == "Business Priority 2A") {
        ...
        this.infocusModel.bp2dSolution2CompanyLogo2 = temp[0].logourl
        this.infocusModel.bp2dSolution2CompanyLocation2 = temp[0].country;
        this.infocusModel.bp2dSolution2CompanyName2 = temp[0].company_name;
        this.infocusModel.bp2dSolution2CompanyDomainName2 = temp[0].domain_name;
        this.infocusModel.bp2dSolution2CompanyMaturityStatus2 = temp[0].maturity;
      }
    } 
    this.infocusEmitEvent();
  }
