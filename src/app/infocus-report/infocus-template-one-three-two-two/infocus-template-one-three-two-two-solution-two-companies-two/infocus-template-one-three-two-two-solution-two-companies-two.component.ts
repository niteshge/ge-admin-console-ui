...
@Component({
  selector: 'app-infocus-template-one-three-two-two-solution-two-companies-two',
  templateUrl: './infocus-template-one-three-two-two-solution-two-companies-two.component.html',
  styleUrls: ['./infocus-template-one-three-two-two-solution-two-companies-two.component.css']
})
export class InfocusTemplateOneThreeTwoTwoSolutionTwoCompaniesTwoComponent implements OnInit {
