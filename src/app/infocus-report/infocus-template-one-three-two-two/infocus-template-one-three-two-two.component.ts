...
@Component({
  selector: 'app-infocus-template-one-three-two-two',
  templateUrl: './infocus-template-one-three-two-two.component.html',
  styleUrls: ['./infocus-template-one-three-two-two.component.css']
})
export class InfocusTemplateOneThreeTwoTwoComponent implements OnInit {
  ...
  postInfocusReport() {
    this.infocusModel.templateType = 4;
