...
@Component({
  selector: 'app-infocus-template-two-solution-three-companies',
  templateUrl: './infocus-template-two-solution-three-companies.component.html',
  styleUrls: ['./infocus-template-two-solution-three-companies.component.css']
})
export class InfocusTemplateTwoSolutionThreeCompaniesComponent implements OnInit {
