...
@Component({
  selector: 'app-infocus-template-one-three-two-three-bp2',
  templateUrl: './infocus-template-one-three-two-three-bp2.component.html',
  styleUrls: ['./infocus-template-one-three-two-three-bp2.component.css']
})
export class InfocusTemplateOneThreeTwoThreeBp2Component implements OnInit {
  ...
  industrySelected(value:string) {
    ...
    this.infocusBusinessPriority1 = this.infocusCoreService.getInfocusBusinessPriority2ByIndustry(this.infocusModel.role, this.infocusModel.industry, this.infocusModel.industrySegment1, this.infocusModel.industrySegment2, randomValue);
  ...
  businessPriority1Selected(value) {
    ...
    let randomValue = Math.random();
    this.infocusCoreService.getInfocusBusinessPriority3ByBp2(this.infocusModel.role, this.infocusModel.industry, this.infocusModel.industrySegment1, this.infocusModel.industrySegment2, this.infocusModel.businessPriority1, randomValue)
      .subscribe(
        (response: Response) => {
          this.bP2 = response;
        }
