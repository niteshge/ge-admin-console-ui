...
export class InfocusReportService {
  ...
  getInfocusBusinessPriority2(role: string, industry: string, industrySegment1: string, industrySegment2: string, businessPriority1: string,randomValue) {
    return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/getbp2/?industry=' + industry + '&industryseg1=' + industrySegment1 + '&role=' + role + '&industryseg2=' + industrySegment2 + '&bp1=' + encodeURIComponent(businessPriority1)+'&ver='+randomValue)
  }
  ...
  getInfocusBusinessPriority3(role: string, industry: string, industrySegment1: string, industrySegment2: string, businessPriority1: string, businessPriority2: string,randomValue) {
    return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/getbp3/?industry=' + industry + '&industryseg1=' + industrySegment1 + '&role=' + role + '&industryseg2=' + industrySegment2 + '&bp1=' + encodeURIComponent(businessPriority1) + '&bp2=' + encodeURIComponent(businessPriority2) +'&ver='+randomValue)
  }
  ...
  getInfocusBusinessPriority3Solution1(role: string, industry: string, industrySegment1: string, industrySegment2: string, businessPriority1: string, businessPriority2: string, businessPriority3: string,randomValue) {
    return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/getsolution1/?industry=' + industry + '&industryseg1=' + industrySegment1 + '&role=' + role + '&industryseg2=' + industrySegment2 + '&bp1=' + encodeURIComponent(businessPriority1) + '&bp2=' + encodeURIComponent(businessPriority2) + '&bp3=' + encodeURIComponent(businessPriority3)+'&ver='+randomValue)
  ...
  getInfocusBusinessPriority3Solution2(role: string, industry: string, industrySegment1: string, industrySegment2: string, businessPriority1: string, businessPriority2: string, businessPriority3: string,randomValue) {
    return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/getsolution2/?industry=' + industry + '&industryseg1=' + industrySegment1 + '&role=' + role + '&industryseg2=' + industrySegment2 + '&bp1=' + encodeURIComponent(businessPriority1) + '&bp2=' + encodeURIComponent(businessPriority2) + '&bp3=' + encodeURIComponent(businessPriority3)+'&ver='+randomValue)
  ...
  getInfocusBusinessPriority3Solution3(role: string, industry: string, industrySegment1: string, industrySegment2: string, businessPriority1: string, businessPriority2: string, businessPriority3: string,randomValue) {
    return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/getsolution3/?industry=' + industry + '&industryseg1=' + industrySegment1 + '&role=' + role + '&industryseg2=' + industrySegment2 + '&bp1=' + encodeURIComponent(businessPriority1) + '&bp2=' + encodeURIComponent(businessPriority2) + '&bp3=' + encodeURIComponent(businessPriority3)+'&ver='+randomValue)
  }
  getInfocusBusinessPriority3Solution4(role: string, industry: string, industrySegment1: string, industrySegment2: string, businessPriority1: string, businessPriority2: string, businessPriority3: string,randomValue) {
    return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/getsolution4/?industry=' + industry + '&industryseg1=' + industrySegment1 + '&role=' + role + '&industryseg2=' + industrySegment2 + '&bp1=' + encodeURIComponent(businessPriority1) + '&bp2=' + encodeURIComponent(businessPriority2) + '&bp3=' + encodeURIComponent(businessPriority3)+'&ver='+randomValue)
  }
  getInfocusBusinessPriority3Solution5(role: string, industry: string, industrySegment1: string, industrySegment2: string, businessPriority1: string, businessPriority2: string, businessPriority3: string,randomValue) {
    return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/getsolution5/?industry=' + industry + '&industryseg1=' + industrySegment1 + '&role=' + role + '&industryseg2=' + industrySegment2 + '&bp1=' + encodeURIComponent(businessPriority1) + '&bp2=' + encodeURIComponent(businessPriority2) + '&bp3=' + encodeURIComponent(businessPriority3)+'&ver='+randomValue)
  }
  ...
  getTechnologies(randomValue){
    return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/gettechnologies?ver='+randomValue);
  }
  getTechnologiesSubSegment(technologyName:string,randomValue){
    return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/gettechsubsegment?technologyName='+technologyName+'ver='+randomValue);
  }
  ...
  getInfocusPDFbyId(id) {
    console.log(id.id)
    const headers = new HttpHeaders({ 'Content-Type': 'application/pdf; charset=utf-8','Access-Control-Allow-Origin': 'http://ge-staging-vm2.eastus.cloudapp.azure.com:8787'});
  ...
  getAllInfocusMeta(randomValue) {
    return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/getallinfocusmetalist?ver='+randomValue);
  }
...
publishPdfById(id, randomValue) {
  console.log(id)
  return this.http.get('http://ge-staging-vm2.eastus.cloudapp.azure.com:8787/api/publishinfocus/?infocusmetaid=' + id+'&ver='+randomValue);
}
